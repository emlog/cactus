...
class SettingsModel: ObservableObject {
    ...
    public var defaultProviders: [String: ProviderSettings] = [
        "ppinfra": ProviderSettings(
            title: NSLocalizedString("ppinfra", comment: "派欧算力云 - 免费"),
        ...
        "OpenRouter": ProviderSettings(
            title: NSLocalizedString("openRouter", comment: "OpenRouter - 免费"),
        ...
        "siliconflow": ProviderSettings(
            title: NSLocalizedString("siliconflow", comment: "硅基流动 - 免费"),
